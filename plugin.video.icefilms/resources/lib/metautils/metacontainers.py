...
class MetaContainer:
    ...
    def Create_Icefilms_Container(self):
    ...
    def make_dir(self, mypath, dirname):
    ...
    def make_dirs(self, path):
            ...
            mainpath = self.make_dir(path, 'meta_caches')
    
            tvpath = self.make_dir(mainpath, 'tvshow')
            tvcovers = self.make_dir(tvpath, 'covers')
            tvbackdrops = self.make_dir(tvpath, 'backdrops')
    
            mvpath = self.make_dir(mainpath, 'movie')
            mvcovers = self.make_dir(mvpath, 'covers')
            mvbackdrops = self.make_dir(mvpath, 'backdrops')
